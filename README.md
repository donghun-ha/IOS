...
2. **사진 편집 앱이 메모리 경고를 자주 받는다면 어떤 순서로 문제를 해결하시겠습니까?**
...
12. **기존 completion handler 기반 코드를 async/await로 마이그레이션할 때 어떤 기준으로 우선순위를 정하시겠습니까?**
...
5. **팀에 새로운 동시성 모델(actor, async/await)을 도입할 때 기술적 리스크와 팀 역량을 어떻게 평가하고 대응하시겠습니까?**
...
8. **금융 앱 개발 시 보안 요구사항과 사용자 편의성 사이의 균형을 어떻게 맞추시겠습니까?**
...
6. **스타트업 CTO로서 iOS 네이티브와 크로스 플랫폼 중 기술 스택을 선택해야 한다면, 어떤 요소들을 고려하여 결정하시겠습니까?**
...
9. **100명 이상의 개발자가 참여하는 대규모 iOS 프로젝트에서 CI/CD 파이프라인을 설계한다면 어떤 전략을 사용하시겠습니까?**
...
18. **기술 스택 선택 시 단기적 실용성과 장기적 확장성을 어떻게 균형을 맞추나요?**
